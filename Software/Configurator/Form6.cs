...
namespace USB_termo_2
{
    public partial class Form6 : Form
    {
        ...
        private void Form6_Load(object sender, EventArgs e) //Действия при загрузке формы 
        {
            Form1 main = this.Owner as Form1; // применяем стандартные значения из первой формы (Form1) для полей
            if (main != null)
            {
                textBox1.Text = main.Msg5_1;
                textBox2.Text = main.Msg5_2;
                textBox3.Text = main.Msg5_3;
                textBox4.Text = main.Msg5_4;
                textBox5.Text = main.Msg5_5;
                textBox6.Text = main.Msg5_6;
                textBox7.Text = main.Msg5_7;
                textBox8.Text = main.Msg5_8;
                textBox9.Text = main.Msg5_9;
                textBox10.Text = main.Msg5_10;
                textBox11.Text = main.Msg5_11;
                textBox12.Text = main.Msg5_12;
                textBox13.Text = main.Msg5_13;
                textBox14.Text = main.Msg5_14;
                textBox15.Text = main.Msg5_15;
                textBox16.Text = main.Msg5_16;
                textBox17.Text = main.Msg5_17;
                textBox18.Text = main.Msg5_18;
                textBox19.Text = main.Msg5_19;
                comboBox1.SelectedItem = main.Msg5_20;
        ...
        private void button2_Click(object sender, EventArgs e) // применяем новые значения для первой формы (Form1) из полей
        {
            ...
            if (main != null)
            {
                main.Msg5_1 = textBox1.Text;
                main.Msg5_2 = textBox2.Text;
                main.Msg5_3 = textBox3.Text;
                main.Msg5_4 = textBox4.Text;
                main.Msg5_5 = textBox5.Text;
                main.Msg5_6 = textBox6.Text;
                main.Msg5_7 = textBox7.Text;
                main.Msg5_8 = textBox8.Text;
                main.Msg5_9 = textBox9.Text;
                main.Msg5_10 = textBox10.Text;
                main.Msg5_11 = textBox11.Text;
                main.Msg5_12 = textBox12.Text;
                main.Msg5_13 = textBox13.Text;
                main.Msg5_14 = textBox14.Text;
                main.Msg5_15 = textBox15.Text;
                main.Msg5_16 = textBox16.Text;
                main.Msg5_17 = textBox17.Text;
                main.Msg5_18 = textBox18.Text;
                main.Msg5_19 = textBox19.Text;
                main.Msg5_20 = (string)comboBox1.SelectedItem;
                main.comboBox8.SelectedItem = "2";
            }
