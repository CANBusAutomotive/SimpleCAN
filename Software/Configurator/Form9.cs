...
namespace USB_termo_2
{
    public partial class Form9 : Form
    {
        ...
        private void Form9_Load(object sender, EventArgs e) //Действия при загрузке формы 
        {
            Form1 main = this.Owner as Form1; // применяем стандартные значения из первой формы (Form1) для полей
            if (main != null)
            {
                textBox1.Text = main.Msg8_1;
                textBox2.Text = main.Msg8_2;
                textBox3.Text = main.Msg8_3;
                textBox4.Text = main.Msg8_4;
                textBox5.Text = main.Msg8_5;
                textBox6.Text = main.Msg8_6;
                textBox7.Text = main.Msg8_7;
                textBox8.Text = main.Msg8_8;
                textBox9.Text = main.Msg8_9;
                textBox10.Text = main.Msg8_10;
                textBox11.Text = main.Msg8_11;
                textBox12.Text = main.Msg8_12;
                textBox13.Text = main.Msg8_13;
                textBox14.Text = main.Msg8_14;
                textBox15.Text = main.Msg8_15;
                textBox16.Text = main.Msg8_16;
                textBox17.Text = main.Msg8_17;
                textBox18.Text = main.Msg8_18;
                textBox19.Text = main.Msg8_19;
                comboBox1.SelectedItem = main.Msg8_20;
        ...
        private void button2_Click(object sender, EventArgs e) // применяем новые значения для первой формы (Form1) из полей
        {
            ...
            if (main != null)
            {
                main.Msg8_1 = textBox1.Text;
                main.Msg8_2 = textBox2.Text;
                main.Msg8_3 = textBox3.Text;
                main.Msg8_4 = textBox4.Text;
                main.Msg8_5 = textBox5.Text;
                main.Msg8_6 = textBox6.Text;
                main.Msg8_7 = textBox7.Text;
                main.Msg8_8 = textBox8.Text;
                main.Msg8_9 = textBox9.Text;
                main.Msg8_10 = textBox10.Text;
                main.Msg8_11 = textBox11.Text;
                main.Msg8_12 = textBox12.Text;
                main.Msg8_13 = textBox13.Text;
                main.Msg8_14 = textBox14.Text;
                main.Msg8_15 = textBox15.Text;
                main.Msg8_16 = textBox16.Text;
                main.Msg8_17 = textBox17.Text;
                main.Msg8_18 = textBox18.Text;
                main.Msg8_19 = textBox19.Text;
                main.Msg8_20 = (string)comboBox1.SelectedItem;
                main.comboBox11.SelectedItem = "2";
            }
